              ...
              <SafeAreaView>
                <ScrollView>
                  <Text
                    ...
                    If you are want create a new bus pass
                  </Text>
                  <View
                    style={{
                      alignItems: 'center',
                  ...
                  <Text
                    ...
                    {'NOTE:- '} Scan the QR code of a registered member to add
                    them to this device. Make sure the member agrees and confirm
                    their identity before proceeding.
                  </Text>
                </ScrollView>
              </SafeAreaView>
            </View>
